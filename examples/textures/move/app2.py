...
if __name__ == "__main__":
    ...
    # en este caso, este vertex program, se encarga de ir saltando d "recuadro" en "recuadro"
    # de la textura (que contiene 4 fotos distintas de la animación de un bloque)

    with open(Path(os.path.dirname(__file__))/ "uv_jump_vertex_program.glsl") as f:
    ...
    img_source = "multi_question_box.png"
    #img_source = "worms.jpg"
    ...
    graph.add_node("move1",
        ...
        transform = tr.identity(),
        texture = sg.Texture(Path(os.path.dirname(__file__)) / img_source,
